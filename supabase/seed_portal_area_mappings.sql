...
--   SUUMO station: "ta=14&ek=XXXXXX"  (未確定のものは空欄)
--   athome/homes:  "/tokyo/minato-city" (パスセグメント)
--
-- ※ SUUMO の ek（駅コード）はポータル独自コードのため
--    空白エントリを追加し、確認後に UPDATE してください。
-- ============================================================
...
('suumo','city','大阪市鶴見区',   '大阪府','大阪市鶴見区',   NULL,'27124','ta=27&sc=27124'),
...
-- ============================================================
-- 【東京都】23区 × AtHome  /tokyo/{ward}-city
-- ============================================================
...
-- ============================================================
-- 【主要駅】× AtHome  station エントリ (神奈川)
-- ※ スラグは要確認: athome のパスが変わった場合は UPDATE で修正してください
-- ============================================================
...
('athome','station','武蔵新城','神奈川県','川崎市高津区','武蔵新城','musashinakahara-station',  '/kanagawa/musashinakahara-station'),
...
-- ============================================================
-- 【SUUMO 駅名 → 所属区/市 の sc コードへのマッピング】
-- SUUMO 独自の ek (駅コード) は非公開のため、
-- 駅が所属する区・市の sc コードで代替検索する。
-- ek コードが判明次第 portal_url_param を "ta=XX&ek=XXXXXX" に UPDATE してください。
-- ============================================================
-- 神奈川 主要駅
